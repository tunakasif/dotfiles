...
local function lsp_keymaps(bufnr)
	...
	buf_set_keymap(bufnr, "n", "<space>d", "<cmd>lua vim.diagnostic.open_float()<CR>", opts)
	...
	buf_set_keymap(bufnr, "n", "<space>sl", "<cmd>lua vim.diagnostic.setloclist()<CR>", opts)
	buf_set_keymap(bufnr, "n", "<space>fm", "<cmd>lua vim.lsp.buf.formatting()<CR>", opts)
